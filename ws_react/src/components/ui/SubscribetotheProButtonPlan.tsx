import './SubscribetotheProButtonPlan.css';

const subscribetotheProButtonPlan = () => {
    return (
        <button className="group relative dark:bg-neutral-800 bg-neutral-200 rounded-full p-px overflow-hidden w-full">
            ...
            <span className="flex items-center justify-center gap-1 relative z-[1] dark:bg-neutral-950/90 bg-neutral-50/90 rounded-full py-3 px-6 w-full">
                ...
                <span className="bg-gradient-to-b ml-1.5 dark:from-white dark:to-white/50 from-neutral-950 to-neutral-950/50 bg-clip-text text-base text-transparent group-hover:scale-105 transition transform-gpu">
                    Assinar o Plano Pro
                </span>
            </span>
        </button>
...
export default subscribetotheProButtonPlan;